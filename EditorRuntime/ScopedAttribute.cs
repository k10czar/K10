...
namespace Skyx.RuntimeEditor
{
    ...
    public class ScopedAttribute : PropertyAttribute
    {
        ...
        private static readonly Dictionary<EScopePreset, ScopedAttribute> presets = new()
        {
            ...
            { EScopePreset.FoldoutPropertyOnly, new ScopedAttribute(EScopeType.Foldout, EEditorInfoSource.Property, EEditorInfoSource.Nothing, EEditorInfoSource.EditorContent, EEditorInfoSource.EditorContent, true) },
