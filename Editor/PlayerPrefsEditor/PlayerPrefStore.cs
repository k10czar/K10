public class PlayerPrefStore {
	...
	public bool Changed
    {
		get 
        {
			...
			switch( value.type )
            {
				case PlayerPrefsEditor.PrefType.Float: return ( value.floatValue != initial.floatValue ) ;
                case PlayerPrefsEditor.PrefType.Int: return ( value.intValue != initial.intValue );
				case PlayerPrefsEditor.PrefType.String: return (value.stringValue != initial.stringValue);
			}
			return false;
		}
	}
