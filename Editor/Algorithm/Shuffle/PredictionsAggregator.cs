...
public static class PreditionsDrawer
{
    ...
    {
		if( _showPreditions.DrawOnTop( ref rect ) )
        {
			var count = aggregated.Count;
    ...
    {
		var height = _showPreditions.GetHeight();
		if( IsShowingPreditions ) 
		{
	...
	public static bool IsShowingPreditions => _showPreditions.Enabled;
	public static bool IsShowingCountingTable => _showCountingTable.Enabled && IsShowingPreditions;
	public static bool IsShowingPermutations => _showPermutations.Enabled && IsShowingPreditions;
}
...
public class PredictionsAggregator
{
    ...
    public void SetData(SerializedProperty entriesProp)
    {
		_count = entriesProp.arraySize;
		EnsureSize(_count);
