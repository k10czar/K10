...
public static class FileAdapter
{
	...
	public static void Debug( string name, string data ) { SaveAsUTF8( GenerateDebugPath() + name, data ); }
	...
	public static void SaveAsUTF8( string path, string data ) { WriteAllBytes( path, System.Text.Encoding.UTF8.GetBytes( data ) ); }
