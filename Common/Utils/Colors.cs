...
// #endif
    ...
    public static class Console
    {
        ...
        [ConstLike] public static readonly Color Info = Cyan;
        ...
        [ConstLike] public static readonly Color BackgroundDarkFilter = AlmostBlack.WithAlpha(.15f);
        ...
        [ConstLike] public static readonly Color SpecialBackground = From(207, 45, 230);
        [ConstLike] public static readonly Color SpecialBackgroundVar = From(191, 0, 191);
